...
%type <treeptr> FieldDeclAssign
%type <treeptr> Type
%type <treeptr> TypeArray
%type <treeptr> OptTypeArray
%type <treeptr> Name
...
FieldDecl:
	...
	| PUBLIC STATIC Type VarDecls ';'
		{ $$ = link_tree(PR_FIELD_DECL_MOD, "FieldDeclMod", 2, $3, $4); }
	;
...
InstantiationExpr:
	...
	| NEW TypeArray
		{ $$ = link_tree(PR_INSTANTIATION_EXPR_ARRAY, "InstantiationExprArray", 1, $2); }
	;
